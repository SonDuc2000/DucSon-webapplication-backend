...
) ENGINE=InnoDB AUTO_INCREMENT=174 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Bảng dữ liệu chứa danh mục sản phẩm';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_saleorder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='Bảng dữ liệu chứa phiếu mua hàng';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_saleorder` VALUES (21,'1629981843572',NULL,NULL,NULL,NULL,NULL,NULL,1,'Nguyen Duc Son','Hà Nội',NULL,NULL,'kuborakid@gmail.com');
...
INSERT INTO `tbl_saleorder_products` VALUES (29,21,115,1,NULL,NULL,NULL,NULL,1);
...
-- Dump completed on 2021-08-27 15:38:52
