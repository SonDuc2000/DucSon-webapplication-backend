...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${base }/user/css/san-pham.css">
	<link rel="stylesheet" type="text/css" href="${base }/user/fontawesome-free-5.15.3-web/css/all.min.css">
		...
		<div class="container" style="margin-top: 20px;">
			<div class="row">
				...
				<div class="col-xl-4 col-lg-4 col-md-3">
					<div class="col-lg-12 ml-auto"><span class="sanpham">CHÍNH SÁCH BÁN HÀNG</span></div>
					...
					<div class="list">
						<ul>
							...
							<li><p>6</p>Miễn phí vận chuyển: Đơn hàng từ 50 triệu trở lên</li>
						</ul>
					</div>
					<!-- Huong dan mua hang -->
					<b style="font-size: 20px; margin-left: 12px;">HƯỚNG DẪN MUA HÀNG</b>
					<div class="col-lg-12" style="margin-top: 4px;">
						<div class="line"></div>
					</div>
					<div class="list">
						<ul>
							<li><p>1</p>Mua hàng trực tiếp tại website http://www.runtime.vn</li>
				...
				<div class="col-lg-8">
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-5">
							<a href="#" class="thumbnail"><img class="img-thumbnail" src="${product.avatar }" alt="" height="120px;"></a>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-7">
							<div class="title">
								<p style="font-weight: bold; font-size: 20px;">${product.title }</p>
							</div>
							<div class="price"><p style="color: #f46164; font-weight: bold; font-size: 20px;">${product.price } $</p></div>
							<div class="desc">
								<div class="line"></div>
								<p style="font-size: 14px; text-align: justify;">${product.details } </p>
								<div class="line"></div>
							</div>
							<div class="btn" style="margin-top: 10px;">
								<div class="number" style="text-align: left; margin-bottom: 10px;">
									<p style="display: inline;">Số lượng: </p>
									<input id="number" style="width: 70px;" type="number" value="1" min="0" max="99">
								</div>
								<button onclick="add(${product.id }, getQuantity ())">THÊM GIỎ HÀNG</button>
		...
		<footer class="bg-dark row">
			...
			<div class="col-lg-3 col-md-4 col-sm-12">
				<div class="ft-title">
					...
					<ul>
						<li><a href="#" style="font-weight: bold;">CEO: NGUYỄN ĐỨC SƠN</a></li>
						<li><a href="#"><i class="fas fa-map-marker-alt p-1"></i>Quận thanh xuân mai dịch, Hà Nội</a></li>
						<li><a href="#"><i class="far fa-envelope p-1"></i>dson.designs@gmail.com</a></li>
						<li><a href="#"><i class="fas fa-phone-alt p-1"></i>phone: 0336816498</a></li>
					</ul>
				</div>
			</div>
		</footer>
