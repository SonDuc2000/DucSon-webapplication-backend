...
<div class="container" style="margin-top: 80px;">
	<div class="row">
		<div class="col-lg-12 ml-auto">
			...
			<select style="font-size: 15px; padding: 8px; cursor: pointer;">
	...
	<c:forEach var="products" items="${product }">
		<div class="col-lg-3 col-md-4 col-sm-6" style="margin-bottom: 30px;">
			<div class="shop">
				<a href="${base }/product/${products.id}" class="thumbnail"><img class="img-thumbnail" src="${products.avatar }" alt="${products.title }" height="109px;"></a>
				<div class="buy"><a href="/product/${products.id }">Xem thêm</a></div>
			</div>
		</div>
	</c:forEach>
	</div>
			...
			<div class="col-lg-4">
				<div class="title">
					...
					<ul>
						...
						<li><a href="#"><i class="fas fa-map-marker-alt"></i>Quận thanh xuân mai dịch, Hà Nội</a></li>
						<li><a href="#"><i class="far fa-envelope"></i>dson.designs@gmail.com</a></li>
						<li><a href="#"><i class="fas fa-phone-alt"></i>phone: 0336816498</a></li>
					</ul>
				</div>
			</div>
		</div>
