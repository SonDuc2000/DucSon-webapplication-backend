							...
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="product" items="${cart.cartItems }">
										<tr>
											<th scope="row"></th>
											<td><a href="${base }/product/${product.productId}"><img class="mr-3 img-thumbnail"
					...
					<c:choose>
						...
						<c:otherwise>
							<form action="${base }/cart/view/access" method="post">
								...
								<div class="row justify-content-center">
									<button type="submit" class="buy text-white" disabled="true">XÁC NHẬN
										ĐƠN HÀNG</button>
								</div>
							</form>
						</c:otherwise>
