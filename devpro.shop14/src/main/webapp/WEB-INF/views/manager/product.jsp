	                                ...
	                                <table id="datatablesSimple">
	                                    ...
	                                    <tbody>
	                                        ...
	                                        <tr>
	                                            ...
	                                            <td style="text-align: center;"><a href="edit-product/${products.id }"><i class="fas fa-edit"></i></a></td></td>
	                                            <td style="text-align: center;"><a href="manager-product/${products.id }">Xóa</a></td>
	                                        </tr>
	                                        </c:forEach>
	                                    </tbody>
	                                </table>
